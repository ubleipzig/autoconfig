...
module.exports = function (overrides) {
	...
	if (dbOptions.adminUser) clientOptions.user = dbOptions.adminUser;
	if (dbOptions.adminPassword) clientOptions.password = dbOptions.adminPassword;
...
function createDb(dsn) {
	...
	try {
		...
		}, clientOptions), dbOptions.dbClient, dbOptions.reuseDb, dbOptions.dropDb);
