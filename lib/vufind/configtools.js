...
exports.findParentConfigs = function (site) {
	...
	var deferred = Q.defer();
	var configPath = path.join(program.basedir, site, 'config', 'vufind');
...
exports.findParentLanguages = function(site) {
	...
	var deferred = Q.defer();
	var languagesPath = path.join(program.basedir, site, 'languages');
...
exports.createConfigs = function (site, defaults, configs, languages) {
	...
	var basePath = path.join(program.basedir, site)
