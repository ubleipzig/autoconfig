...
exports.handler = (argv) => {
	...
	var dbTools = require('../../vufind/dbtools')({
		...
		vanillaSqlFile: path.join(argv.basedir, 'module/VuFind/sql/mysql.sql')
	});
	...
	// spread all tasks
	Q.all([
		skipConfig || configTools.processConfig().then(() => {
			return skipUpdateSettings || configTools.updateSettings();
		}).then(() => {
