...
program
	...
	.option('-c, --configs [value]', 'the folder with default overrides. they must follow the naming convention <site>.json')
...
if (!program.configs) {
	program.configs = path.join(process.env.HOME, '.autoconfig/');
}
